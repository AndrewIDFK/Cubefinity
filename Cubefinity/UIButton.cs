...
{
     public class UIButton : UIHoverableButton
    {
        ...
        public UIButton(Texture2D texture, Rectangle bounds, Vector2 screenPos, string text, SpriteFont font, Color buttonColor, Color textColor)
        {
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(MainGame.font, Text, new Vector2(ScreenPos.X + Bounds.X + Bounds.Width / 2 - MainGame.font.MeasureString(Text).X / 2, ScreenPos.Y + Bounds.Height / 2 - MainGame.font.MeasureString(Text).Y / 2), TextColor);
        }
    }
}